...
<template>
  ...
  >
    <div class="py-6 px-4 md:px-6 xl:px-7.5">
      <h4 class="text-xl font-bold text-black">Top Products</h4>
    </div>
    ...
    >
      ...
      <div class="col-span-2 hidden items-center sm:flex">
        <p class="text-sm font-medium text-black">{{ product.category }}</p>
      </div>
      <div class="col-span-1 flex items-center">
        <p class="text-sm font-medium text-black">${{ product.price }}</p>
      </div>
      <div class="col-span-1 flex items-center">
        <p class="text-sm font-medium text-black">{{ product.sold }}</p>
      </div>
      <div class="col-span-1 flex items-center">
