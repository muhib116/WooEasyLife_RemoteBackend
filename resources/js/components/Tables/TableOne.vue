...
<template>
  ...
  >
    <h4 class="mb-6 text-xl font-semibold text-black">Top Channels</h4>
    ...
    <div class="flex flex-col">
      ...
      >
        <div class="flex items-center gap-3 p-2.5 xl:p-5">
          ...
          <p class="hidden text-black sm:block">{{ brand.name }}</p>
        </div>

        <div class="flex items-center justify-center p-2.5 xl:p-5">
          <p class="text-black">{{ brand.visitors }}K</p>
        </div>
        ...
        <div class="hidden items-center justify-center p-2.5 sm:flex xl:p-5">
          <p class="text-black">{{ brand.sales }}</p>
        </div>
