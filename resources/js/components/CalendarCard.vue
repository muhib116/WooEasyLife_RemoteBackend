...
<template>
  <div
    class="w-full max-w-full rounded-sm border border-stroke bg-white shadow-default"
  >
    ...
    <div class="grid grid-cols-7">
      <div
        ...
        :key="index"
        class="ease relative h-20 cursor-pointer border border-stroke p-2 transition duration-500 hover:bg-gray md:h-25 md:p-6 xl:h-31"
      >
        <div
          class="mx-auto flex h-24 w-10 flex-col overflow-hidden sm:w-full md:h-40 md:w-20 lg:w-28 2xl:w-40"
        >
          <span class="font-medium text-black">{{ day.date }}</span>
          ...
          >
            ...
            <div
              class="event invisible absolute left-2 z-99 mb-1 flex w-[200%] flex-col rounded-sm border-l-[3px] border-primary bg-gray px-3 py-1 text-left opacity-0 group-hover:visible group-hover:opacity-100 md:visible md:w-[190%] md:opacity-100"
            >
