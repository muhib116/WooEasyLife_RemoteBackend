<template>
  ...
  <div
    class="overflow-hidden rounded-sm border border-stroke bg-white shadow-default"
  >
    ...
    <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
      ...
      <div class="mt-4">
        <h3 class="mb-1.5 text-2xl font-medium text-black">Danish Heilium</h3>
        <p class="font-medium">Ui/Ux Designer</p>
        <div
          class="mx-auto mt-4.5 mb-5.5 grid max-w-94 grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1"
        >
          <div
        ...
        <div class="mx-auto max-w-180">
          <h4 class="font-medium text-black">About Me</h4>
        ...
        <div class="mt-6.5">
          <h4 class="mb-3.5 font-medium text-black">Follow me on</h4>
