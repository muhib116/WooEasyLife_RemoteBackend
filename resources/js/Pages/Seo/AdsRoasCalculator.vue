...
const playbook = [
    {
        title: 'ফেক রেট কমান',
        body: 'অর্ডার কনফার্মের আগে মোবাইল নম্বর দিয়ে কুরিয়ার সাকসেস রেট দেখুন। ঝুঁকিপূর্ণ অর্ডার শিপ করবেন না।',
...
const guideSections = [
    ...
    },
    {
        ...
        paragraphs: [
            ...
            'Pixel ইভেন্ট পরিষ্কার রাখুন: শুধু কনফার্মড অর্ডার Purchase হিসেবে যাক। রিটার্ন লস ক্যালকুলেটর দিয়ে মাসিক অপারেশন লস মাপুন। কুরিয়ার অটো এন্ট্রি চালু থাকলে কনফার্মড অর্ডার দ্রুত শিপ হয় — অপারেশন লিক কম হয়।',
