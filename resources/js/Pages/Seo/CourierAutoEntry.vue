...
const guideSections = [
    ...
    },
    {
        ...
        paragraphs: [
            'অটো এন্ট্রি দ্রুত, কিন্তু ঝুঁকিপূর্ণ অর্ডার অটো পার্সেল পাঠানো উচিত নয়। প্রথমে মোবাইল নম্বর দিয়ে কুরিয়ার হিস্টোরি ও সাকসেস রেট দেখুন। কম সাকসেস রেট বা বারবার রিটার্ন হলে ফোন-কনফার্ম বা হোল্ড করুন।',
                ...
                <article v-for="section in guideSections" :key="section.heading" class="space-y-3">
                    ...
                    >
                        ...
                        <template v-else-if="section.heading.startsWith('নিরাপদ ওয়ার্কফ্লো') && idx === 0">
                            অটো এন্ট্রি দ্রুত, কিন্তু ঝুঁকিপূর্ণ অর্ডার অটো পার্সেল পাঠানো উচিত নয়। প্রথমে
                            <Link href="/bd-fraud-checker" class="font-semibold text-amber-400 hover:text-amber-300">BD Fraud Checker</Link>
