...
<template>
    ...
    <div>
                ...
                >
                    ...
                    <div class="flex items-center lg:order-2">
                        ...
                        <a
                            href="#"
                            target="_blank"
                            class="rounded-lg bg-purple-700 px-4 py-2 text-sm font-medium text-white hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800 sm:mr-2 lg:mr-0 lg:px-5 lg:py-2.5"
                            >Download</a
                        >
                        <button
        ...
        <section class="bg-white dark:bg-gray-900">
            <div
                class="mx-auto grid max-w-screen-xl px-4 pb-8 pt-20 lg:grid-cols-12 lg:gap-8 lg:py-16 lg:pt-28 xl:gap-0"
            >
                <div class="mr-auto place-self-center lg:col-span-7">
                    ...
                    >
                        ...
                        >
                        and the
                        <a href="https://flowbite.com/blocks/" target="_blank"
                            >Blocks System</a
                        >.
                    </p>
                    <div class="space-y-4 sm:flex sm:space-x-4 sm:space-y-0">
                        ...
                        <a
                            ...
                            target="_blank"
                            class="mb-2 mr-2 inline-flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-5 py-3 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700 sm:w-auto"
                        >
                            <svg
                                class="mr-2 h-4 w-4"
                                id="Layer_1"
                    ...
                    <div class="text-gray-500 dark:text-gray-400 sm:text-lg">
                        ...
                        >
                            <li class="flex space-x-3">
                                <svg
                                    class="h-5 w-5 flex-shrink-0 text-purple-500 dark:text-purple-400"
                                    fill="currentColor"
                                    viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg"
                                >
        ...
        <section class="bg-white dark:bg-gray-900">
            ...
            >
                <div class="col-span-2 mb-8">
                    <p
                        class="text-lg font-medium text-purple-600 dark:text-purple-500"
                    >
                        Trusted Worldwide
                    </p>
                    <h2
                        class="mb-4 mt-3 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white md:text-3xl"
                    >
                        Trusted by over 600 million users and 10,000 teams
                    </h2>
                    <p
                        class="font-light text-gray-500 dark:text-gray-400 sm:text-xl"
                    >
                    ...
                    <div
                        class="mt-6 space-y-4 border-t border-gray-200 pt-6 dark:border-gray-700"
                    >
                        <div>
                            <a
                                href="#"
        ...
        <section class="bg-gray-50 dark:bg-gray-800">
            <div
                class="mx-auto max-w-screen-xl px-4 py-8 text-center lg:px-6 lg:py-24"
            >
                <figure class="mx-auto max-w-screen-md">
                    ...
                    <blockquote>
                        <p
                            class="text-xl font-medium text-gray-900 dark:text-white md:text-2xl"
                        >
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="mx-auto max-w-screen-xl px-4 py-8 lg:px-6 lg:py-24">
                <div class="mx-auto mb-8 max-w-screen-md text-center lg:mb-12">
                    ...
                    <p
                        class="mb-5 font-light text-gray-500 dark:text-gray-400 sm:text-xl"
                    >
                ...
                >
                    ...
                    >
                        ...
                        <p
                            class="font-light text-gray-500 dark:text-gray-400 sm:text-lg"
                        >
                        ...
                        <a
                            href="#"
                            class="rounded-lg bg-purple-600 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-purple-700 focus:ring-4 focus:ring-purple-200 dark:text-white dark:focus:ring-purple-900"
                            >Get started</a
                        >
                    </div>
            ...
            <div class="mx-auto max-w-screen-xl px-4 pb-8 lg:px-6 lg:pb-24">
                ...
                <div class="mx-auto max-w-screen-md">
                    ...
                    >
                        ...
                        >
                            <div
                                class="border-b border-gray-200 py-5 dark:border-gray-700"
                            >
                                <p
        ...
        <footer class="bg-white dark:bg-gray-800">
            <div
                class="mx-auto max-w-screen-xl p-4 py-6 md:p-8 lg:p-10 lg:py-16"
            >
                <div
