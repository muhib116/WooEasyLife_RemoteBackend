...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('site_gsc_query_metrics_staging')) {
            Schema::create('site_gsc_query_metrics_staging', function (Blueprint $table) {
                $table->id();
        ...
        if (! Schema::hasTable('site_gsc_page_metrics_staging')) {
            Schema::create('site_gsc_page_metrics_staging', function (Blueprint $table) {
                $table->id();
                $table->string('page_url', 500);
    ...
    {
        Schema::dropIfExists('site_gsc_page_metrics_staging');
        Schema::dropIfExists('site_gsc_query_metrics_staging');
    }
};
