...
return [
    'faq' => [
        [
            ...
            'paragraphs' => [
                ...
                'প্রতিটি প্রশ্নের আলাদা পেজ আছে: সরাসরি উত্তর, BD COD-এর ৳ প্রসঙ্গ, WooEasyLife-এ কীভাবে কাজ করে (শুধু লাইভ ফিচার), আর ছোট SOP। টুল শুরু করতে পারেন /bd-fraud-checker বা /fake-order-protection থেকে; ট্রায়াল /pricing।',
        ...
        [
            ...
            'paragraphs' => [
                ...
                'ফ্রি টুল: /bd-fraud-checker · /fake-customer-check · /bd-courier-ratio-checker। SteadFast ফোকাস পিলার: /steadfast-fraud-check। চেক শুধু সিগন্যাল দেয়—অন্ধভাবে অটো পার্সেল পাঠায় না; সিদ্ধান্ত আপনার।',
            ],
        ],
        [
        ...
        [
            ...
            'paragraphs' => [
                'মোবাইলে পুশ নোটিফিকেশন, কল ID ম্যাচ ও মাল্টি-স্টোর QR পেয়ারিং দিয়ে বাইরে থেকেও অর্ডার approve বা hold করা যায়। বিস্তারিত: /woocommerce-mobile-app। মেটা AI বট বা অ্যাপ লক এখনো লাইভ নয়—দাবি করি না।',
            ],
        ],
        [
            'heading' => 'এআই সারাংশ',
    ...
    'faq_courier_success_rate_kivabe_bujhbo' => [
        [
            ...
            'paragraphs' => [
                ...
                'টুল: /bd-courier-ratio-checker · /bd-fraud-checker। টুল সিগন্যাল দেয়—অন্ধভাবে অটো পার্সেল পাঠায় না।',
            ],
        ],
        [
            'heading' => 'BD COD-তে কেন গুরুত্বপূর্ণ',
            'paragraphs' => [
                'প্রতিটি রিটার্নে ডেলিভারি চার্জ, রিটার্ন ফি, প্যাকিং আর অ্যাড CPA যায়। দিনে ৫০ অর্ডারে ৩০% রিটার্ন হলে মাসে শত শত পার্সেল নষ্ট—রেট না পড়ে পার্সেল পাঠালে এই ৳ লুকিয়ে থাকে।',
        ...
        [
            'heading' => 'মিনি SOP',
            'paragraphs' => [
                'কনফার্মের আগে এই ধাপগুলো একবার করে নিন—টিমের সবাই একই রুল মানলে ভুল পার্সেল পাঠানো কমে।',
            ],
            'list' => [
    ...
    'faq_success_rate_kom_hole_ki_korbo' => [
        [
            'heading' => 'দ্রুত উত্তর',
            'paragraphs' => [
                'সাকসেস রেট কম হলে অন্ধভাবে COD পার্সেল পাঠাবেন না। আগে ফোন-কনফার্ম বা চেকআউট OTP নিন, ঠিকানা পরিষ্কার করুন, প্রয়োজনে হোল্ড রাখুন বা অগ্রিম ডেলিভারি চার্জ ছাড়া পার্সেল পাঠাবেন না।',
        ...
        [
            'heading' => 'BD COD-তে কেন গুরুত্বপূর্ণ',
            'paragraphs' => [
                'লাল জোনে অন্ধভাবে পার্সেল পাঠানো মানে প্রায় নিশ্চিত রিটার্ন ফি, প্যাকিং আর অ্যাড খরচ। একটা “একবার ট্রাই” অর্ডারও কয়েকশ থেকে হাজার ৳ খরচ করতে পারে—মাসে কয়েক ডজন হলে লাভ মরে যায়।',
                'টিম যদি একই নম্বর বারবার ভুল পার্সেল পাঠায়, লস গুণিতক হয়। নোট ও ব্ল্যাকলিস্ট ছাড়া স্টাফ একই ভুল রিপিট করে।',
        ...
        [
            ...
            'paragraphs' => [
                'সবুজ বা উচ্চ রেট: দ্রুত কনফার্ম করে অটো এন্ট্রি। হলুদ বা মাঝারি: কল বা কন্ডিশনাল OTP, ঠিকানা যাচাই, তারপর approve। লাল বা খুব কম সাকসেস: অগ্রিম ছাড়া পার্সেল পাঠাবেন না—হোল্ড বা বাতিল, নোট লিখে রাখুন।',
    ...
    'faq_cod_order_otp_kokhon' => [
        ...
        [
            ...
            'paragraphs' => [
                'উচ্চ রেট: সাধারণত OTP ছাড়াই কনফার্ম করা যায়। মাঝারি রেট: ছোট কল বা কন্ডিশনাল OTP। কম রেট বা নতুন নম্বর: OTP বা হোল্ড—অন্ধভাবে পার্সেল পাঠানো নয়।',
    ...
    'faq_woocommerce_customer_blacklist' => [
        ...
        [
            ...
            'paragraphs' => [
                ...
                'শুধু নোট রাখলে স্টাফ ভুলে আবার পার্সেল পাঠাতে পারে। ব্ল্যাকলিস্ট চেকআউটেই আটকায়।',
            ],
        ],
        [
            'heading' => 'WooEasyLife-এ কীভাবে',
    ...
    'faq_customer_delivery_history_check' => [
        ...
        [
            'heading' => 'BD COD-তে কেন গুরুত্বপূর্ণ',
            'paragraphs' => [
                'হিস্টোরি ছাড়া পার্সেল পাঠানো মানে জুয়া। একটা লাল নম্বর এড়ালেই এক রাউন্ড রিটার্ন ফি বাঁচে; মাসে দশটা এড়ালে লাখের হিসাব হতে পারে।',
