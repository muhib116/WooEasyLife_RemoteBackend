...
return array (
  ...
  array (
    ...
    array (
      ...
      1 => 'পার্সেল পাঠানোর পর “পার্সেল কোথায়?” কল সাপোর্ট ঘণ্টা খায়। In Transit ও বিশেষ করে Out for Delivery মেসেজ কাস্টমারকে COD টাকা রেডি ও রাইডার কল এক্সপেক্ট করতে শেখায়—কাস্টমার নট এভেলেবল রিটার্ন কমে।',
