...
return [
    ...
    'hero' => [
        'badge' => '🚀 শুধুমাত্র WooCommerce স্টোরের জন্য',
        'headline' => 'ফেক অর্ডারে কি প্রতি মাসে হাজার হাজার টাকা লস হচ্ছে?',
        'headline_accent' => 'অর্ডার কনফার্মের আগে কাস্টমারের কুরিয়ার হিস্টোরি যাচাই করুন।',
    ...
    */
    ...
    'fraud_benefit_cards' => [
        'headline' => 'অর্ডার কনফার্ম করার আগে কাস্টমারের Courier History দেখে নিন।',
