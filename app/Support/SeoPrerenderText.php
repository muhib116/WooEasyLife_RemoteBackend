...
class SeoPrerenderText
{
    ...
    private const PATH_LABELS = [
        ...
        '/woocommerce-facebook-messenger' => ['bn' => 'Facebook Messenger ইনবক্স', 'en' => 'Facebook Messenger inbox'],
        '/en/woocommerce-facebook-messenger' => ['bn' => 'Messenger ইনবক্স (EN)', 'en' => 'Facebook Messenger inbox'],
