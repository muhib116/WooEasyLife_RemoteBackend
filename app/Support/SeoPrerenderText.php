...
class SeoPrerenderText
{
    ...
    private const PATH_LABELS = [
        ...
        '/steadfast-return-hub' => ['bn' => 'বাংলা Return Hub (app.wpsalehub.com/steadfast-return-hub)', 'en' => 'Bangla Return Hub (app.wpsalehub.com/steadfast-return-hub)'],
        '/en/steadfast-return-hub' => ['bn' => 'ইংরেজি Return Hub (app.wpsalehub.com/en/steadfast-return-hub)', 'en' => 'English Return Hub (app.wpsalehub.com/en/steadfast-return-hub)'],
        '/woocommerce-facebook-messenger' => ['bn' => 'Facebook Messenger ইনবক্স (app.wpsalehub.com/woocommerce-facebook-messenger)', 'en' => 'Facebook Messenger inbox (app.wpsalehub.com/woocommerce-facebook-messenger)'],
        '/en/woocommerce-facebook-messenger' => ['bn' => 'Messenger ইনবক্স ইংরেজি (app.wpsalehub.com/en/woocommerce-facebook-messenger)', 'en' => 'English Messenger inbox (app.wpsalehub.com/en/woocommerce-facebook-messenger)'],
        ...
        '/woocommerce-mobile-app' => ['bn' => 'WooEasyLife মোবাইল অ্যাপ', 'en' => 'WooEasyLife mobile app'],
        '/en/woocommerce-mobile-app' => ['bn' => 'WooEasyLife অ্যাপ (EN)', 'en' => 'WooEasyLife mobile app'],
