    ...
    private static function knowledgeItems(int $count, string $scope): array
    {
        $templates = $scope === 'platform'
            ...
            : [
                ...
                ['faq', 'Order cancel', 'অর্ডার ক্যান্সেল?', 'শিপমেন্টের আগে ক্যান্সেল সম্ভব কিনা অর্ডার আইডি দিলে হিউম্যান নিশ্চিত করবে।', ['cancel', 'ক্যান্সেল']],
                ...
                ['faq', 'Track parcel', 'পার্সেল ট্র্যাক?', 'কুরিয়ার ট্র্যাকিং নম্বর শিপমেন্টের পর মেসেজে যায়।', ['track']],
