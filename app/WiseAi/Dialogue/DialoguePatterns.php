...
final class DialoguePatterns
{
    ...
    public const CATALOG = [
        ...
        'ask_payment' => ['label' => 'Ask payment method', 'family' => 'commerce'],
        'ask_cod' => ['label' => 'Ask cash on delivery', 'family' => 'commerce'],
        'ask_stock_bare' => ['label' => 'Ask stock (no offer yet)', 'family' => 'commerce'],
        'ask_stock_on_offer' => ['label' => 'Ask stock on known offer', 'family' => 'commerce'],
